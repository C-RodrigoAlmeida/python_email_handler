        ...
        for field_name, field in self.fields.items():
            if field_name == 'subject' or field_name == 'description':
                field.widget.attrs.update({
                    'class': 'form-control backdrop-blur bg-[#202c33] mb-8 border-b-2 border-gray-300 w-full focus:outline-none focus:border-emerald-600',
                })
            else:
                field.widget.attrs.update({
                    'class': 'form-control backdrop-blur bg-[#202c33] mb-8 border-2 border-gray-300 w-full focus:outline-none focus:border-emerald-600',
                })
